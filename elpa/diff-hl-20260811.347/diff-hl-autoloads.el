...
Specifically, Diff-Hl-Amend mode is enabled in all buffers where `turn-on-diff-hl-amend-mode' would do it.
...
Specifically, Diff-Hl-Show-Hunk-Mouse mode is enabled in all buffers where `diff-hl-show-hunk-mouse-mode' would do it.
