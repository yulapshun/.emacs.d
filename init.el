...
(custom-set-variables
 ...
 '(package-selected-packages
   '(avy company compile-angel dashboard diff-hl dockerfile-mode doom-modeline editorconfig embark-consult evil
         ...
         org-roam-ui persp-projectile perspective php-mode popper powershell projectile rotate smartparens
         symbol-overlay treesit-auto vertico vundo web-mode yaml-mode yasnippet))
