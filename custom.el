(custom-set-variables
 ...
 '(package-selected-packages
   '(vertico-prescient gcmh smooth-scrolling good-scroll eglot popper markdown-mode sqlite3 treesit-auto org-roam-ui org-fragtog embark embark-consult consult marginalia vertico org-roam org-roam-timestamps org nadvice json-mode avy dashboard undo-tree pyvenv pyvenv-auto ido-vertical-mode yasnippet-snippets company-box vundo yasnippet yaml-mode web-mode use-package symbol-overlay solarized-theme pug-mode projectile php-mode org-superstar magit ido-completing-read+ gruvbox-theme go-mode git-gutter flycheck flx-ido eyebrowse exec-path-from-shell dockerfile-mode company-web auto-compile all-the-icons-dired))
